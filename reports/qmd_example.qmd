...
![](../results/horse_pops_plot.png){width=80%}

Horse populations over time for all provinces in Canada from 1906 - 1972.
:::
...
![](../results/horse_pops_plot_largest_sd.png){width=65%}

Horse populations for the province with the largest standard deviation.
:::

In [@fig-horse-pops-prov] we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
